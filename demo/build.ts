...
const STYLE_PATH = path.join(DEMO_DIR, 'style.css');
...
// Build Mermaid conditional script (same logic as wrapInTemplate)
...
console.log(`  Has MathJax: ${result.mathjaxCss ? 'yes' : 'no'}`);